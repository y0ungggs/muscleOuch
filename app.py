...
with tab5:
    ...
    st.info(
        "※ 해당 팀원분들께는 6월 13일까지 15만원 상당의 신발 구매 지원금을 드리오니, 신발을 고른 후 이메일 또는 사내 메신저로 개별 연락 바랍니다.(DT사업팀 김영수 주임)😄<br>"
    ...
    if len(certified_50plus) > 0:
        ...
        st.info(
            "50회 이상 인증한 회원 중<br>이번에 우승한 7팀, 기존 블랙리스트 인원을 제외한 회원만 사다리타기를 통해<br>단 1명에게 15만원 상당의 신발 구매 지원금을 드리오니,\n"
    ...
    st.info(
        "부족한 점을 보완하여 하반기 이벤트를 준비하겠습니다.<br>"
        "다음에도 많은 관심과 참여 부탁드립니다!<br>"
