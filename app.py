...
with tab5:
    ...
    # 0. 많은 참여 감사 인사
    st.info("안녕하세요. 근육통 총무 김영수입니다!!  \n 팀전으로 처음 진행한 제 1회 운동 인증회에 적극 참여해주신 모든 동호회원분들께 진심으로 감사드립니다!")
    ...
    st.write(f"총 37명의 회원 중 {certified_3plus_count}명의 회원이 3회 이상 인증을 완료하셨습니다.")
    ...
    st.write(f"🏆 가장 많이 인증한 팀은 **{top_team_name}**입니다🎉🎉  \n 총 인증 횟수는 **{top_team_cert_sum}회** 입니다.  \n축하드립니다🎉🎉🎉🎉")
